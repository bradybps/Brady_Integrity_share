...
#elif defined (CONFIG_MACH_BPS313XV1)

# define IRQ_WLAN_INT			(IRQ_BOARD_START)	/* WLAN chip */
# define IRQ_LAN9200_ETH_INT	(IRQ_BOARD_START+1)	/* Ethernet chip */
# define IRQ_BT_RECEIVE_INT      (IRQ_BOARD_START+2)
# define NR_IRQ_BOARD		3

/* now define board irq to event pin map */
#define BOARD_IRQ_EVENT_MAP	{ \
	{IRQ_WLAN_INT, EVT_GPIO15, EVT_ACTIVE_LOW}, \
	{IRQ_LAN9200_ETH_INT, EVT_I2SRX_DATA0, EVT_ACTIVE_LOW}, \
	{IRQ_BT_RECEIVE_INT, EVT_UART_RXD, EVT_ACTIVE_LOW},\
	}
/* Following defines group the board IRQs into 4 IRQ_EVNTR groups.
   IRQ_EVT_ROUTERx IRQ is generated when event in the corresponding 
   group triggers.
*/
#define IRQ_EVTR0_START        IRQ_WLAN_INT
#define IRQ_EVTR0_END          IRQ_WLAN_INT
#define IRQ_EVTR1_START        IRQ_LAN9200_ETH_INT
#define IRQ_EVTR1_END          IRQ_LAN9200_ETH_INT
#define IRQ_EVTR2_START        IRQ_BT_RECEIVE_INT
#define IRQ_EVTR2_END          IRQ_BT_RECEIVE_INT
#define IRQ_EVTR3_START        0
#define IRQ_EVTR3_END          0
